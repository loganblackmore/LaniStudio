...
CommandProcessor.RegisterCommand("/ticket", "cmd_ticket")
CommandProcessor.RegisterCommand("/o1", "cmd_o1")
CommandProcessor.RegisterCommand("/o2", "cmd_o2")
CommandProcessor.RegisterCommand("/o3", "cmd_o3")
CommandProcessor.RegisterCommand("/o4", "cmd_o4")
CommandProcessor.RegisterCommand("/shelp", "cmd_shelp")

cmd_ticket:
SendChat("/me достал из кармана КПК и зашёл в базу данных")
Sleep 2100
SendChat("/me нашёл нужного заключённого в базе данных")
Sleep 2100
SendChat("/me начислил заключённому штрафные баллы")
Sleep 1000
SendChat(CommandProcessor.TempText)
return

cmd_o1:
SendChat("/me приподнял матрас")
Sleep 2100
SendChat("/me провел рукой под матрасом")
Sleep 1050
SendChat("/anim 17 5")
Sleep 1050
SendChat("/me посмотрел под кровать")
Sleep 2100
SendChat("/do Под матрасом есть ли предметы?")
Sleep 2100
SendChat("/n Отвечайте в /do")
return

cmd_o2:
SendChat("/me посмотрел под умывальник")
Sleep 2100
SendChat("/me поднял крышку умывальника")
Sleep 2100
SendChat("/me осмотрел водосток умывальник")
Sleep 2100
SendChat("/do В водостоке умывальника есть ли предметы?")
Sleep 2100
SendChat("/n Отвечайте в /do")
return

cmd_o3:
SendChat("/me поднял стульчак унитаза")
Sleep 2100
SendChat("/me поднял крышку унитаза")
Sleep 1050
SendChat("/anim 16 4")
Sleep 1050
SendChat("/me осмотрел внимательно каждую щель")
Sleep 2100
SendChat("/do В унитазе есть ли предметы?")
Sleep 2100
SendChat("/n Отвечайте в /do")
return

cmd_o4:
SendChat("/do На поясе охранника висит подсумок.")
Sleep 2100
SendChat("/me открыл подсумок, после чего взял оттуда перчатки")
Sleep 2100
SendChat("/me надел перчатки на руки, после чего подошел к заключенному")
Sleep 2100
SendChat("/me протянул руки к заключённому, после чего провел руками по верхним частям тела")
Sleep 2100
SendChat("/me провел руками по нижним частям тела заключенного")
Sleep 2100
SendChat("/do У заключённого имеется что-нибудь?")
Sleep 2100
SendChat("/n отвечайте в /do")
return

cmd_shelp:
showDialog(0, "Alcatraz Helper for Kerry_Statham by Sergey Lani", "/ticket id деньги причина - выписать штраф`n/o1, /o2, /o3, /o4 - обыск`n", "Ok")
return
